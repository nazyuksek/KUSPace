...
import { readDistrictQuery, readPitchDistrictQuery, readUsernameQuery } from '../../App';
...
const PitchSearch = ({ navigation }: PitchSearchProps) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.pitches}>
                {pitches?.map((el, i) => <Text style={styles.resultText} key={i}>{el.pitch_name}</Text>)}
            </View>
        </SafeAreaView >
    );
}
